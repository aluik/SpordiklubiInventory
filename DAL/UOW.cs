...
namespace DAL
{
    public class UOW : IUOW, IDisposable
    {
        ...
        public IEFRepository<User> Users => GetStandardRepo<User>();
        public IEFRepository<UserType> UserTypes => GetStandardRepo<UserType>();
        public IEFRepository<Renting> Rentings => GetStandardRepo<Renting>();
        public IEFRepository<Inventory> Inventories => GetStandardRepo<Inventory>();
        public IEFRepository<InventoryType> InventoryTypes => GetStandardRepo<InventoryType>();
        public IEFRepository<Footwear> Footwears => GetStandardRepo<Footwear>();
        public IEFRepository<FootwearType> FootwearTypes => GetStandardRepo<FootwearType>();
