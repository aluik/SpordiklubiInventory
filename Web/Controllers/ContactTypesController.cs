...
namespace Web.Controllers
{
    public class ContactTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContactTypeId,ContactTypeValue")] ContactType contactType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContactTypeId,ContactTypeValue")] ContactType contactType)
        {
            if (ModelState.IsValid)
            {
